...
> 状态:implemented · 提出 2026-09-07 · 拍板 2026-09-07(口头,选 B) · 合入 2026-09-07 · 来源 2026-09-07 [并行工具](../implemented/2026-09-07-parallel-tools.md) 实现时点出的既有缺口(不是它引入的)<br>
> **形态的家就是本条**:投影这一层的设计文档 [Context 与 Message Flow](../../design/context-and-message-flow.md) 还是审阅稿、不是契约,所以补齐的机制写在这里。那份转正之后搬过去,本条只留取舍
