...
export const RUN_SOURCE: Readonly<Record<string, Term>> = {
  ...
  subagent: { zh: "子 agent", en: "subagent", tone: "info", hint: "模型用 subagent 工具派出的隔离子循环：自己的 transcript（fresh 空白、fork 继承父的），链回派出它的那次工具调用" },
...
export const RECORD_TERMS: Readonly<Record<string, Term>> = {
  ...
  "extension.generation.mounted": { zh: "扩展已装载", en: "extension.generation.mounted", tone: "neutral", hint: "一代 extension 全部装上：各自 inject 连到了谁、provide 了什么" },
  "extension.generation.mount_failed": { zh: "扩展装载失败", en: "extension.generation.mount_failed", tone: "critical", hint: "这一代没装上并已回滚：prepare 是声明 / 依赖图被拒，apply 是某个 Entry 自己抛错" },
  "extension.generation.unmounted": { zh: "扩展已卸载", en: "extension.generation.unmounted", tone: "neutral", hint: "一代 extension 逆序卸下；cleanupErrors 是清理时失败的 disposer 数" },
